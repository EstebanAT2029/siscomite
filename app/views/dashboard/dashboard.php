...
<div class="row g-4">
    ...
    <div class="col-md-3">
        <div class="panel-card p-4 text-center">
            ...
            <p class="text-muted">Añadir, Activar. Desactivar</p>
    ...
    <div class="col-md-3">
        <div class="panel-card p-4 text-center">
            ...
            <h4 class="mb-1">Gestión de Jefes</h4>
            <p class="text-muted">Añadir, Eliminar Jefes</p>
    ...
    <div class="col-md-3">
        <div class="panel-card p-4 text-center">
            ...
            <h4 class="mb-1">Mantenimiento Actas</h4>
            <p class="text-muted">Buscar, editar y reemitir actas</p>
            <a href="#modalEnConstruccion" class="btn btn-panel-cyan w-100" data-bs-toggle="modal">Gestionar</a>
    ...
    <div class="col-md-3">
        <div class="panel-card p-4 text-center">
            ...
            <a href="#modalEnConstruccion" class="btn btn-panel-yellow w-100 text-dark" data-bs-toggle="modal">Ingresar</a>
        </div>
    </div>
        ...
        <div class="modal-content shadow">
            ...
            <div class="modal-body text-center">
                <p class="mb-3 text-muted">
                    El <b>Módulo</b> se encuentra actualmente en desarrollo.<br>
                    Estará disponible en una próxima versión del sistema. Gracias.
                </p>
            </div>
